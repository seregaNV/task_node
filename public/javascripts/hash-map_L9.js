$(document).ready(function() {
    ...
    $('#js_t9_input').on('click', function () {
        key = $('#js_t9_inputKey').val();
        value = $('#js_t9_inputValue').val();
        map.put(key, value);
        console.log('Пару додано.');
    });

    $('#js_t9_parserStringAndAddMap').on('click', function () {
        inputString = $('#js_t9_inputString').val();
        map.parserStringAndAddMap(inputString);
        console.log('Кількість доданих пар: ' + map.parserStringAndAddMap(inputString));
    });

    $('#js_t9_string').on('click', function () {
        console.log(map.toLine());
    });

    $('#js_t9_entrySet').on('click', function () {
        console.log(map.entrySet());
    });

    $('#js_t9_output').on('click', function () {
        output = $('#js_t9_outputKey').val();
    ...
    $('#js_t9_del').on('click', function () {
        delKey = $('#js_t9_delKey').val();
    ...
    $('#js_t9_isEmpty').on('click', function () {
        map.isEmpty();
        console.log('HashMap - пустий? ("' + map.isEmpty() + '").');
    });

    $('#js_t9_checkKey').on('click', function () {
        map.size();
...
HashMap.prototype.toLine = function() {
    var s = "{";
